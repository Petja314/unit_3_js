...
function f1() {
   ...
   num = +a.value;
   document.querySelector('.out-1').innerHTML = num == 4;
}
...
function f3() {
   let inner = document.querySelector('.out-3');
...
function f4() {
   let output = document.querySelector('.out-4');
...
function f7() {
   ...
   let step = +document.querySelector('.i-72').value;
   out.innerHTML = num ** step;
...
function f10() {
   ...
   let result = +document.querySelector('.s-100').value;
...
function f11() {
   ...
   let result = +document.querySelector('.s-110').value;
   out.innerHTML = result;
}
...
function f12() {
   // мое решение без подсказки
   // let result = document.querySelector('.i-120').value;
   // let out = document.querySelector('.out-12');
   // out.innerHTML = (typeof result);
   let v = i120.value;
...
function f13() {
   let result = document.querySelector('.i-130').value;
...
function f14() {
   ...
   let func = document.querySelector('.s-143').value;
...
function f15() {
   ...
   let func = document.querySelector('.s-153').value;
